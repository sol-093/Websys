<?php
/**
 * Template variables are provided by handleDashboardPage() in dashboard_page.php.
 *
 * @var array $activityPreview
 * @var array $announcements
 * @var array $dashboardOrganizationsPreview
 * @var array $highestPressure
 * @var array $joinedIds
 * @var array $joinRequestStatus
 * @var array $latestAnnouncementsPreview
 * @var array $orgs
 * @var array $pendingAssignments
 * @var array $pendingAssignmentsPagination
 * @var array $summary
 * @var array $summaryAttentionRows
 * @var array $summaryPagination
 * @var array $summaryRankingRows
 * @var array $topPerformer
 * @var array $transactions
 * @var array $user
 * @var float $averageNet
 * @var float $balance_delta_pct
 * @var float $expenses_delta_pct
 * @var float $income_delta_pct
 * @var float $kpiBalance
 * @var float $kpiExpense
 * @var float $kpiIncome
 * @var float $latestTrendNet
 * @var float $peakExpenseValue
 * @var float $summaryExpenseTotal
 * @var float $summaryIncomeTotal
 * @var float $summaryNetTotal
 * @var int $balanceRatio
 * @var int $expensePreviousMonthCount
 * @var int $expenseRatio
 * @var int $healthyMonthCount
 * @var int $incomePreviousMonthCount
 * @var int $latestAnnouncementCount
 * @var int $pendingAssignmentCount
 * @var int $previousMonthTransactionCount
 * @var int $recentReportCount
 * @var int $trendPointCount
 * @var string $dashboardTimestamp
 * @var string $latestTrendDirectionLabel
 * @var string $peakExpenseMonth
 */
?>
